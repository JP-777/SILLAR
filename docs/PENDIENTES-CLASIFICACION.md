...
| **13** | ~~Probar el aborto de la ADR-019 en vivo~~ — **CERRADA el 20 de septiembre de 2026** | Era «lo único que la decisión promete» y llevaba sin disparador desde el principio. El disparador escrito —la próxima vez que se toque el instalador— se cumplió, y el host se observó negándose a arrancar: `91793fa`. Registrada en `BITACORA.md` §7 |
