...
internal sealed class FeaturedProjectConfiguration : IEntityTypeConfiguration<FeaturedProject>
{
    public void Configure(EntityTypeBuilder<FeaturedProject> builder)
    {
        builder.ToTable("featured_projects", table =>
        {
            ...
            table.HasCheckConstraint("ck_featured_projects_alt_text_si_hay_imagen", CmsConfiguration.AltTextWithImage);
            table.HasCheckConstraint("ck_featured_projects_alt_text_no_vacio", CmsConfiguration.OptionalNotEmpty("alt_text"));
